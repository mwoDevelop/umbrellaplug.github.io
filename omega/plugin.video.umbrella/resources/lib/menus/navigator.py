...
class Navigator:
	...
	def mdblistTools(self, folderName=''):
		...
		self.addDirectoryItem(40709, 'movies_mdblistCollectionManager', 'mdblist.png', 'DefaultAddonService.png', isFolder=False)
		self.addDirectoryItem(40710, 'shows_mdblistCollectionManager', 'mdblist.png', 'DefaultAddonService.png', isFolder=False)
